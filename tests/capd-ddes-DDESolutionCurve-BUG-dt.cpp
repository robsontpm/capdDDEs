#define BOOST_TEST_MODULE DDESolutionCurveBugTests2
...
BOOST_AUTO_TEST_CASE(Dt_Bug) {
    ...
    BOOST_CHECK_THROW(curve.dt(), std::logic_error);
    BOOST_TEST_MESSAGE("Bug confirmed: dt fails because piece dt is not implemented.");
}
