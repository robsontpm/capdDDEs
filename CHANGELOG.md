...
Experimental support of cmake build system. 
It works similar to the old make Makefile system, with
autodiscovery (to rethink in the fuure).  

### Changed

Separated old (no boost::test) and new (Boost) test,
