...
#ifndef _CAPD_>>PUT YOUR FILENAME HERE<<_HPP_
#define _CAPD_>>PUT YOUR FILENAME HERE<<_HPP_

#include <capd/ddes/DDECommon.hpp>
#include <capd/ddes/>>PUT YOUR FILENAME HERE<<.h>

#endif /* _CAPD_>>PUT YOUR FILENAME HERE<<_HPP_ */
