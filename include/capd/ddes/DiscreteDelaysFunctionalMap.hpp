...
#ifndef _CAPD_DDES_DISCRETEDELAYSFUNCTIONALMAP_HPP_
#define _CAPD_DDES_DISCRETEDELAYSFUNCTIONALMAP_HPP_
...
template<
	...
	typename JetSpec
>
const double DiscreteDelaysFunctionalMap<FinDimMapSpec, SolutionCurveSpec, JetSpec>::ROUGH_MULFACT = 1.05;
...
template<
	...
	typename JetSpec
>
const double DiscreteDelaysFunctionalMap<FinDimMapSpec, SolutionCurveSpec, JetSpec>::ROUGH_REFINE_FACTOR = 0.8;
...
template<
	...
	typename JetSpec
>
const double DiscreteDelaysFunctionalMap<FinDimMapSpec, SolutionCurveSpec, JetSpec>::ROUGH_TRIALSTEP = 0.1;
...
template<
	...
	typename JetSpec
>
const typename DiscreteDelaysFunctionalMap<FinDimMapSpec, SolutionCurveSpec, JetSpec>::size_type
DiscreteDelaysFunctionalMap<FinDimMapSpec, SolutionCurveSpec, JetSpec>::ROUGH_LIMIT = 32;


} // namespace ddes
} // namespace capd

#endif /* _CAPD_DDES_DISCRETEDELAYSFUNCTIONALMAP_HPP_ */
