...
protected:
  size_type m_rows,m_cols;
   ...
   /*
     Symbols below has to have visibility=hidden. Without that we get a lot of warnings from linker:
ld: warning: direct access in ....  to global weak symbol capd::vectalg::MatrixContainer<Z2, 0u, 0u>::defaultCols means the weak symbol cannot be overridden at runtime. This was likely caused by different translation units being compiled with different visibility settings.
    */
  DLL_LOCAL static size_type defaultRows, defaultCols;
