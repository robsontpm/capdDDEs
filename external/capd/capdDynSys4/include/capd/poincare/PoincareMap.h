...
protected:
  ...
  void updateJacEnclosure(C0Set&, C0Set& next){ updateTime(next); }
  void updateJacEnclosure(C1Set& prev, C1Set& next);
  void updateJacEnclosure(C2Set& prev, C2Set& next);
  void updateJacEnclosure(CnSet& prev, CnSet& next);
