...
C2OdeSolver<MapType,StepControlPolicy,EnclosurePolicy,CurveT>::C2OdeSolver(MapType& vectorField,size_type order)
  : BasicOdeSolver<MapType,StepControlPolicy,CurveT>(vectorField,order),
    OdeSolver<MapType,StepControlPolicy,EnclosurePolicy,CurveT>(vectorField,order),
    BasicC2OdeSolver<MapType,StepControlPolicy,CurveT>(vectorField,order)
{}
